...
class TruyenController extends Controller
{
    ...
    {
        //
        $list_truyen = Truyen::with('theloaitruyen')->orderBy('íd','DESC')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate(
            ...
            'tom tat' => 'required|max:255',
            'kichhoat' => 'required',
            'image'=>'required|image|mimes:jpg,gif,svg|max:2048|dimensions:min_width=100,min_height=100,max_width=1000,max_height=1000',
            'theloai_id'=>'required',
            ],
            [
            'tentruyen.unique' => 'Ten truyen da co, xin dien ten khac',
            'slug_truyen.unique' => 'Slug truyen da co, xin dien slug  khac',
            'tentruyen.required' => 'Ten truyen phai co',
            'tomtat.required' => 'tom tat phai co',
            'image.required' => 'hinh anh phai co',
            ]
        );
        // $data = $request->all();
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('status','cap nhat truyen thanh cong');         
    }
