...
class TheLoaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate(
            ...
            [
            'tentheloai.unique' => 'Ten the loai da co, xin dien ten khac',
            'slug_theloai.unique' => 'Slug the loai da co, xin dien slug  khac',
            'tentheloai.required' => 'Ten the loai phai co',
            'mota.required' => 'mo ta phai co'
            ]
        );
        // $data = $request->all();
        ...
        return redirect()->back()->with('status','them the loai thanh cong');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->validate(
            ...
            [
            'tentheloai.required' => 'Ten the loai phai co',
            'slug_theloai.required' => 'slug the loai phai co',
            'mota.required' => 'mo ta phai co'
            ]
        );
        // $data = $request->all();
        ...
        return redirect()->back()->with('status','cap nhat the loai thanh cong');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('status','xoa the loai thanh cong');
    }
